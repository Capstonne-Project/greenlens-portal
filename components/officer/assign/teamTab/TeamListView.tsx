...
import { MoreHorizontal, RefreshCw, Search, Users } from 'lucide-react';
      ...
      <div className="overflow-hidden rounded-lg border border-border bg-card shadow-sm">
          ...
          <TableBody>
            ...
            {!isLoading && !isError && listFiltered.length === 0 && (
              <TableRow>
                <TableCell
                  colSpan={8}
                  className="h-32 px-3 py-2 text-center text-sm text-slate-500"
                >
        ...
        <div className="flex items-center justify-between border-t border-slate-200 px-3 py-2">
          <span className="text-xs text-slate-500">
            {isLoading ? 'Đang tải...' : `${listPagination.totalItems} đội`}
          </span>
