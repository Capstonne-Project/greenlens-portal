...
/** LEO dashboard placeholder — DEO uses live `/v1/dashboard/deo/*` APIs. */
export function LeoDashboardPlaceholder() {
  return (
    <div className="space-y-5">
      <div className="rounded-2xl bg-[#0f1117] px-6 pb-7 pt-6">
        <div className="mb-5">
          <h1 className="text-xl font-bold text-white">Dashboard Tổng quan</h1>
          <p className="text-sm text-slate-400">Cán bộ phường (LEO)</p>
        </div>
