...
export type TrackingDatePreset = 'today' | 'yesterday' | 'last7' | 'last30' | 'last6months' | 'all';

export type TrackingDateRangeValue = {
  preset: TrackingDatePreset | 'custom';
...
type TrackingDateRangePickerProps = {
...
const PRESETS: { key: TrackingDatePreset; label: string }[] = [
...
function rangeFromPreset(preset: TrackingDatePreset): DateRange | undefined {
...
function formatTriggerLabel(value: TrackingDateRangeValue, range: DateRange | undefined): string {
...
function valueToRange(value: TrackingDateRangeValue): DateRange | undefined {
...
export function TrackingDateRangePicker({
  ...
  const [draftPreset, setDraftPreset] = useState<TrackingDatePreset | 'custom'>(value.preset);
  ...
  const syncDraftFromValue = (next: TrackingDateRangeValue) => {
  ...
  const handlePreset = (preset: TrackingDatePreset) => {
